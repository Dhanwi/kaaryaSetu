...
const Login = () => {
  ...
  return loggedin ? null : (
    <GoogleOAuthProvider clientId={import.meta.env.VITE_GOOGLE_CLIENT_ID}>
      <div className="relative flex items-center justify-center min-h-screen bg-[#02101E] p-4">
        <div className="flex flex-col lg:flex-row items-center gap-8 justify-center w-full max-w-6xl mt-20  rounded-3xl p-6">
          <div className="flex flex-col w-full lg:w-1/2 items-center justify-center text-center gap-4">
            <div className="text-[#22D3EE] text-xl md:text-2xl mb-1 font-serif italic">
              Welcome Back!{" "}
            </div>
            <div className="text-[#22D3EE] text-sm md:text-base mb-1 font-serif italic">
              Your Career Progression Awaits!{" "}
              <FaStar className="inline-block" /> Log in to your profile and
              unlock a world of{" "}
              <span className="text-[#06B6D4]">Opportunity</span> tailored just
              for you. Dive into your{" "}
              <span className="text-[#06B6D4]">KaaryaSetu</span> experience and
              embark on a journey that could elevate your career to new heights.{" "}
              <div className="text-[#22D3EE] text-sm md:text-base mt-5 font-serif italic">
            ...
            <div className="text-[#22D3EE] text-3xl md:text-4xl mb-6 font-serif italic">
              KaaryaSetu
            </div>
            <div>
              <h1 className="text-2xl md:text-4xl font-bold text-center mb-4 font-serif text-[#22D3EE]">
                Your Next <span className="text-[#06B6D4]">Opportunity</span> is
                Just a <span className="text-[#06B6D4]">Login</span> Away!{" "}
              </h1>
            </div>

            <div className="text-[hsl(0,0%,100%)] flex flex-col items-center gap-5">
              <div className="text-center mt-4 text-sm md:text-md font-serif font-thin">
          ...
          <div className="bg-[#041124] bg-opacity-10 backdrop-blur-lg shadow-xl shadow-cyan-500/20 rounded-3xl border-x-2 border-cyan-500/50 px-6 py-3 w-full lg:w-1/2 max-w-lg h-auto lg:h-[65vh] overflow-y-auto custom-scrollbar">
            <div>
              {forgotPassword ? (
                <ResetPassword onBackToLogin={handleBackToLogin} />
              ) : (
                <>
                  <div className="flex items-center text-[#22D3EE] justify-center mt-6 md:mt-10 mb-5 text-sm md:text-base">
