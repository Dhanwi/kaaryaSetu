...
const TermsConditions = () => {
  return (
    <div className="bg-[#02101E] text-cyan-400 min-h-screen mt-14 p-4 sm:p-6 md:p-8 lg:p-10">
      <div className="max-w-4xl mx-auto shadow-xl shadow-cyan-500/20 border border-cyan-500/50 p-4 sm:p-6 md:p-8 lg:p-10 rounded-2xl">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-cyan-400 mb-4 sm:mb-6">
          Terms & Conditions
        </h1>
        ...
        <section className="mt-4 sm:mt-6">
          <h2 className="text-xl sm:text-2xl font-semibold text-cyan-400 flex items-center">
