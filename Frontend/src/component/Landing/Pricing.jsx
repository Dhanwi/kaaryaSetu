...
export default function Pricing() {
  ...
  return (
    <div className="py-16 px-6 md:px-16 bg-gradient-to-r from-[#02101E] via-[#041124] to-[#020C1B] text-white">
      ...
      <div className="mt-12 grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        {/* Free Plan */}
        <div className="border border-cyan-500 rounded-lg shadow-xl shadow-cyan-500/20 p-6 bg-[#041124] hover:shadow-cyan-500/50 transition-all duration-300">
          ...
          <div className="mt-6 text-center">
            <button
              className="bg-cyan-500 text-white py-2 px-4 rounded-lg hover:bg-cyan-600 transition-all duration-300"
              onClick={() =>
                authenticated
        ...
        <div className="border border-blue-500 rounded-lg shadow-xl shadow-blue-500/20 p-6 bg-gradient-to-r from-[#041124] to-[#020C1B] hover:shadow-blue-500/50 transition-all duration-300">
