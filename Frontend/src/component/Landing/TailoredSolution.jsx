  ...
  return (
    <div className="bg-[#041124] overflow-hidden flex flex-col mt-10 p-10">
      <div className="relative flex flex-col items-center justify-center">
        <h2 className="text-lg font-bold text-white z-10">Tailored Solution</h2>
...
const Feature = ({ title, description, icon, points, index }) => {
  ...
  return (
    <div className={`${baseClasses} ${borderClasses}`}>
      ...
      <p className="text-sm text-white dark:text-neutral-300 max-w-xs relative z-10 mb-4 px-10">
        {description}
      </p>
      <ul className="list-disc list-inside text-[#ccfbf1] dark:text-neutral-300 max-w-xs relative z-10 px-10">
